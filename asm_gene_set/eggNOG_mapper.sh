...
#SBATCH --output=/vast/eande106/projects/Lance/THESIS_WORK/gene_annotation/processed_data/eggNOG_mapper/elegans/scripts/SLURM_output/eggNOG_priv_euk.oe  
#SBATCH --error=/vast/eande106/projects/Lance/THESIS_WORK/gene_annotation/processed_data/eggNOG_mapper/elegans/scripts/SLURM_output/eggNOG_priv_euk.rr
...
#	-o N2_longestIso_background --cpu 24

#emapper.py -m diamond -i /vast/eande106/projects/Lance/THESIS_WORK/gene_annotation/processed_data/eggNOG_mapper/elegans/input/c_elegans.PRJNA13758.WS283.csq.PCfeaturesOnly.longest.protein.fa \
#	--data_dir /vast/eande106/projects/Lance/THESIS_WORK/gene_annotation/software/eggNOG_mapper/databases \
#	--seed_ortholog_evalue 0.001 --tax_scope 6231 \
#	--output_dir /vast/eande106/projects/Lance/THESIS_WORK/gene_annotation/processed_data/eggNOG_mapper/elegans/output \
#	--temp_dir /vast/eande106/projects/Lance/THESIS_WORK/gene_annotation/processed_data/eggNOG_mapper/elegans/temp \
#	-o N2_longestIso_background_nematoda --cpu 24

#emapper.py -m diamond -i /vast/eande106/projects/Lance/THESIS_WORK/gene_annotation/processed_data/eggNOG_mapper/elegans/input/WBGene_gene_sets/private.fa \
#	--data_dir /vast/eande106/projects/Lance/THESIS_WORK/gene_annotation/software/eggNOG_mapper/databases \
#	--seed_ortholog_evalue 0.001 --tax_scope eukaryota \
#	--output_dir /vast/eande106/projects/Lance/THESIS_WORK/gene_annotation/processed_data/eggNOG_mapper/elegans/output \
#	--temp_dir /vast/eande106/projects/Lance/THESIS_WORK/gene_annotation/processed_data/eggNOG_mapper/elegans/temp \
#	-o N2_longestIso_private_euk --cpu 24
