...
# Which N2 genes is BRAKER3 missing in N2 BRAKER3 predictions?
...
#######################################################################################################################################
### Looking at non-N2 - AFTER REMOVING SINGLE-EXON GENES ###
#######################################################################################################################################
all_relations_clean <- all_relations %>% dplyr::rename_with(~ gsub("_count", "", .x))
...
#######################################################################################################################################
### Looking at non-CGC1 - AFTER REMOVING SINGLE-EXON GENES ###
#######################################################################################################################################
all_relations_clean <- all_relations %>% dplyr::rename_with(~ gsub("_count", "", .x))
