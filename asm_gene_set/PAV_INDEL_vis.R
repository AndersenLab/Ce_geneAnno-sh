...
vcf_lance <- readr::read_tsv("/vast/eande106/projects/Lance/THESIS_WORK/gene_annotation/processed_data/paftools/elegans/vcf/updated_genomes/elegans.merged.1kbCOV.5kbALIGN.annotated.final.vcf") #JU2617 is not present (correctly, it is not an isotype ref so we don't have HDRs for it) 
# I changed PB306 to it's correct name of ECA259


vfilt_lance <- vcf_lance %>%
